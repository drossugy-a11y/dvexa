...
from governance.skill_score import SkillScore, MINIMUM_SAMPLES, CONSECUTIVE_FAILURE_THRESHOLD, RECOVERY_SUCCESS_THRESHOLD
...
def evaluate_lifecycle(current_status: SkillStatus, score: SkillScore) -> SkillStatus:
...
def evaluate_recovery(score: SkillScore) -> str:
