...
class SystemDirective:
    ...
    def to_system_prompt(self) -> str:
        ...
        return (
            ...
            "CRITICAL: You must produce EXACTLY ONE consolidated response.\n"
            "Do NOT simulate multi-step conversations.\n"
            "Do NOT generate Step 1 / Step 2 as separate messages.\n"
            "Do NOT write dialogue for both yourself and the user.\n"
            "Do NOT use numbered steps in your response.\n"
            "Do NOT ask follow-up questions unless the user explicitly requests them.\n"
            "Do NOT generate continuation prompts like 'Let me know if...' or 'Is there anything else...'.\n"
            "Produce a single, complete, final answer. Then stop.\n\n"
